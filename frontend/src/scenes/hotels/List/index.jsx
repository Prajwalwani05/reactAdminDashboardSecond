...
import { HotelRounded, ListAlt, TrendingUpOutlined } from "@mui/icons-material";
import { colorModeContext, tokens } from "../../../theme";
import { PiCaretDoubleUpDuotone , PiCaretDoubleDownDuotone} from "react-icons/pi";
import LineChart from "../../../components/lineChart";
import '../style.css';
import pngImage from './ongImage.png';
...
const List = () => {
  ...
  const [showGraph, setShowGraph] = React.useState('available');

  const handleChange = (event) => {
    setShowGraph(event.target.value);
  };

  const lineChartData = [400,100,1200,500,1000,180,770];
  return (
    <Box m="10px">
      <CustomSeparator
        pageName={"List"}
      ...
      >
        ...
        >
          ...
          ></path>
          <path
            fill={colors[`${colorScheme}Accent`]?.[200]}
          ...
          ></path>
          <path
            fill={colors[`${colorScheme}Accent`]?.[300]}
          ...
          ></path>
          <path
            fill={colors[`${colorScheme}Accent`]?.[400]}
          ...
          <defs>
            ...
            >
              <stop
                stop-color={colors[`${colorScheme}Accent`]?.["accent"]}
              ></stop>
              <stop
                offset="1"
                stop-color={colors[`${colorScheme}Accent`]?.[200]}
              ></stop>
            </linearGradient>
            <linearGradient
              id="b"
      ...
      <Box>
        <RadialChart value={67} height1={300} width={300} labels={'Tours'}/>
        <RadialChart value={40} height1={250} width={250} labels={'My Tours'}/>
      </Box>
      ...
      <Grid container spacing={2.5}>
          ...
          >
            ...
            >
              <Box display="flex" flexDirection="column" gap="5px">
                ...
                <Typography variant="h6" component="div" display='flex'justifyContent='flex-start' alignItems='center'>
                <PiCaretDoubleUpDuotone style={{color:'#38b000'}} /> 
                 + 2.6 %
                </Typography>
              </Box>
              <Box>
          ...
          >
            ...
            >
              <Box display="flex" flexDirection="column" gap="5px">
                ...
                <Typography variant="h6" component="div" display='flex'justifyContent='flex-start' alignItems='center'>
                <PiCaretDoubleUpDuotone style={{color:'#38b000'}} /> + 2.0 %
                </Typography>
              </Box>
              <Box>
                <Box
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop
                          stop-color={
                            colors[`${colorScheme}Accent`]?.["accent"]
                          }
                        ></stop>
                        <stop
                          offset="1"
          ...
          >
            ...
            >
              <Box display="flex" flexDirection="column" gap="5px">
                ...
                <Typography variant="h6" component="div" display='flex'justifyContent='flex-start' alignItems='center'>
                <PiCaretDoubleDownDuotone style={{color:'red'}}/> - 0.1 %
                </Typography>
              </Box>
              <Box>
                <Box
        ...
        >
          ...
          <defs>
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop stop-color={colors[`${colorScheme}Accent`]?.[300]}></stop>
              <stop offset="1" stop-color={colors[`${colorScheme}Accent`]?.[200]}></stop>
            </linearGradient>
          </defs>
                   </svg>
                </Box>
        ...
        <Card
          ...
          >
           <CardContent
            ...
            >
            <Box mb={1} sx={{width:'100%',borderRadius:'20px',padding:'5px', backgroundColor:colors.primary['specialCards']}}>
            <Grid container spacing={1}>
            <Grid item xs={6}>
            <Card sx={{ backgroundColor: colors[`${colorScheme}Accent`]?.[400], backgroundImage:'none', borderRadius:'20px'}} className="cardImage">
            <div style={{padding: "20px", width:'100%', height:'100%',backgroundImage: `url(${pngImage})`,
            ...
            <Box display='flex' justifyContent='space-between' alignItems='flex-start'>
              <Box>
               <Typography variant="h6" style={{fontWeight:'600',color: colors[`${colorScheme}Accent`]?.[100]}}>
                Total Incomes
                </Typography> 
                <Typography variant="h1" style={{color: colors[`${colorScheme}Accent`]?.[100], fontWeight:'600'}}>
                  $ 10,500
                </Typography>
                </Box>
              <Box>
              <Typography variant="h5" style={{color: colors[`${colorScheme}Accent`]?.[100], fontWeight:'600'}} display='flex'justifyContent='space-between' gap='8px' alignItems='center'>
              <TrendingUpOutlined /> 2.78 %
                </Typography>
                <Typography variant="h6" style={{color: colors[`${colorScheme}Accent`]?.[100], opacity:0.5}}>
                Last Month
                </Typography> 
              </Box>
            </Box>
            <Box>
              <LineChart lineChartData1={lineChartData} linecolor={[colors[`${colorScheme}Accent`]?.[100]]} height={150} width={'100%'}/>
            </Box>
            </div>
          </Card>
            </Grid>
            <Grid item xs={6}>
            <Card sx={{padding:'20px', background:'transparent', backgroundImage:'none', boxShadow:'none'}}>
             <Typography variant="h4" style={{fontWeight:'600'}}>
                Booked
                </Typography>
                <Box my={3}>
                <Box  my={2.5} display='flex' flexDirection='column' justifyContent='center' alignItems='center' gap='10px' >
                 <Box width='100%' display='flex' justifyContent='space-between' alignItems='center'>
                  <Typography variant="h6" style={{fontWeight:'600'}}>PENDING</Typography>
                  <Typography variant="h6" style={{fontWeight:'600'}}>6.91K</Typography>
                 </Box>
                  <LinearDeterminate bg={colors.yellowAccent[300]} userProgress={6.91}/>
                </Box>
                <Box my={2.5}  display='flex' flexDirection='column' justifyContent='center' alignItems='center' gap='10px' >
                 <Box width='100%' display='flex' justifyContent='space-between' alignItems='center'>
                  <Typography variant="h6" style={{fontWeight:'600'}}>CANCELLED</Typography>
                  <Typography variant="h6" style={{fontWeight:'600'}}>1.95K</Typography>
                 </Box>
                  <LinearDeterminate bg={colors.redAccent[200]} userProgress={1.95}/>
                </Box>
                <Box my={2.5}  display='flex' flexDirection='column' justifyContent='center' alignItems='center' gap='10px' >
                 <Box width='100%' display='flex' justifyContent='space-between' alignItems='center'>
                  <Typography variant="h6" style={{fontWeight:'600'}}>SOLD</Typography>
                  <Typography variant="h6" style={{fontWeight:'600'}}>9.12K</Typography>
                 </Box>
                  <LinearDeterminate bg={colors.greenAccent[300]} userProgress={9.12}/>
                </Box>
                </Box>
              </Card>
              </Grid>
            ...
            <Box sx={{width:'100%',borderRadius:'20px',padding:'5px', backgroundColor:colors.primary['specialCards']}}>
            <Grid container spacing={0}>
            <Grid  sx={{display:'flex', justifyContent:'flex-start', alignItems:'center'}} item xs={6}>
            <Card
            sx={{
              padding: "0px",
              borderRadius: "20px",
          ...
          >
            ...
            <RadialChart OffsetValue={5}  valueFontSize={'14px'} size={45} color={[colors[`${colorScheme}Accent`]?.[500]]} gradientColor={[colors[`${colorScheme}Accent`]?.[300]]} value={[73]} height1={250} width={180}/>
               <Box>
                <Typography variant="h3" style={{fontWeight:'600'}}>
                38,566
                </Typography>
                 <Typography variant="h6" style={{fontWeight:'600',color: colors.grey[700]}}>
                  Sold
                </Typography>
              </Box>
            </Box>
              ...
              <hr style={{margin:'0', borderWidth:'0px thin 0px 0px', borderColor:colors.grey[800],height:'auto', alignSelf:'stretch', borderStyle:'dashed'}}/>
            <Grid  sx={{display:'flex', justifyContent:'flex-start', alignItems:'center'}} item xs={5}>
            <Card
            sx={{
              padding: "0px",
              borderRadius: "20px",
          ...
          >
             <Box display='flex' justifyContent='center' alignItems='center'>
            <RadialChart OffsetValue={5}  valueFontSize={'14px'} size={45} color={[colors.yellowAccent[500]]} gradientColor={[colors.yellowAccent[300]]} value={[42]} height1={250} width={180} />
               <Box>
                <Typography variant="h3" style={{fontWeight:'600'}}>
                18,456
                </Typography>
        ...
        <Card
          ...
          >
            ...
            >
            <Box sx={{width:'100%'}} mb={1.6} pt={1}>
              <Typography variant="h4" style={{fontWeight:'600'}}>Tours available</Typography>
              <Grid>
              {
                showGraph === 'soldOut' ? 
                <RadialChart color={[colors[`${colorScheme}Accent`]?.[500]]}  size={60} gradientColor={[colors[`${colorScheme}Accent`]?.[300]]} value={[83]} valueFontSize={'20px'} OffsetValue={15} labelFontSize={'18px'} labels={'Tours'} height1={420} width={370}/>
                :
                <RadialChart color={[colors.greenAccent[500]]}  size={60} gradientColor={[colors.greenAccent[300]]} value={[54]} valueFontSize={'20px'} OffsetValue={15} labelFontSize={'18px'} labels={'Tours'} height1={420} width={370}/>
              }
              </Grid>
            </Box>
            <Box p={1} pb={0} sx={{width:'100%'}}>
              <Box width='100%'  display='flex' justifyContent='space-between' alignItems='center'>
                {/* <Typography display='flex' gap='5px' alignItems='center' ><CheckCircleRoundedIcon  style={{color: colors[`${colorScheme}Accent`]?.[500]}}/> Sold out</Typography> */}
                <RadioGroup
                style={{width:'100%'}}
                ...
                >
                  <Box display='flex' justifyContent='space-between' alignItems='center'>
                   {/* <Typography display='flex' gap='5px' alignItems='center' ><RadioButtonUncheckedRoundedIcon /> Available</Typography> */}
                   <Typography>
                   <FormControlLabel value="soldOut" control={<Radio sx={{
                          color: colors[`${colorScheme}Accent`]?.[500],
                          '&.Mui-checked': {
                            color: colors[`${colorScheme}Accent`]?.[500],
                          },
                        }}/>} label="Sold out" />
                   </Typography>
                   <Typography>120 tours</Typography>
                   </Box>
                   <Box display='flex' justifyContent='space-between' alignItems='center'>
                {/* <Typography display='flex' gap='5px' alignItems='center' ><RadioButtonUncheckedRoundedIcon /> Available</Typography> */}
                    <FormControlLabel value="available" control={<Radio color="success"/>} label="Available" />
                    <Typography>66 tours</Typography>
                   </Box>
                </RadioGroup>
                {/* <Typography>120 tours</Typography> */}
              </Box>
