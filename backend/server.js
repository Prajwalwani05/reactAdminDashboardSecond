...
const exp = require('constants');
  ...
  const port = process.env.MY_PORT || 9000;
  console.log(port)
  ...
  // MongoDB connection                  
  mongoose.connect('mongodb+srv://prajwalwani05:5ucFwHzYbbtzKu3Y@cluster0.oqnmu.mongodb.net/adminDashboard?retryWrites=true&w=majority', { 
