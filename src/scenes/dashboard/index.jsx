...
import img2 from './assets/cover-4.webp';
import img3 from './assets/cover-5.webp';
import img4 from './assets/cover-6.webp';
        ...
        <Grid container spacing={2.5}>
          <Grid item xs={8}>
            <Item
              className="firstGrid"
              style={{
                backgroundImage:`url(https://images.unsplash.com/photo-1476445704028-a36e0c798192?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)`
              }}
            >
              <Box className="firstGridOverlay" px={5} py={4}>
                <Box className="content">
                  <span>
                    Welcome back 👋 <p>Jaydon Frankie</p>
                  </span>
                ...
                <Box className="content2">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop stop-color={colors[`${colorScheme}Accent`]?.[100]}></stop>
                        <stop
                          offset="1"
